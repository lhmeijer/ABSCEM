...
class DiagnosticClassifier:
    ...
    def create_file_hidden_layers(self):
        ...
        te_atp_corr_pred = indices['te_atp_correct_predicted']
        te_atp_wrong_pred = indices['te_atp_wrong_predicted']
        te_natp_corr_pred = indices['te_natp_correct_predicted']
        te_natp_wrong_pred = indices['te_natp_wrong_predicted']
        ...
        tr_atp_corr_pred_fv = self.create_feature_set(x_training[tr_atp_corr_pred], train_aspects[tr_atp_corr_pred],
                                                      tr_word_sentiments[tr_atp_corr_pred],
                                                      tr_aspect_sentiments[tr_atp_corr_pred],
                                                      tr_relations[tr_atp_corr_pred], tr_pos_tags[tr_atp_corr_pred],
                                                      tr_mentions[tr_atp_corr_pred])

        with open(self.neural_language_model.config.tr_file_of_hid_atp_corr_pred, 'w') as outfile:
            json.dump(tr_atp_corr_pred_fv, outfile, ensure_ascii=False)

        tr_atp_wrong_pred_fv = self.create_feature_set(x_training[tr_atp_wrong_pred], train_aspects[tr_atp_wrong_pred],
                                                       tr_word_sentiments[tr_atp_wrong_pred],
                                                       tr_aspect_sentiments[tr_atp_wrong_pred],
                                                       tr_relations[tr_atp_wrong_pred],
                                                       tr_pos_tags[tr_atp_wrong_pred], tr_mentions[tr_atp_wrong_pred])

        with open(self.neural_language_model.config.tr_file_of_hid_atp_wrong_pred, 'w') as outfile:
            json.dump(tr_atp_wrong_pred_fv, outfile, ensure_ascii=False)

        tr_natp_corr_pred_fv = self.create_feature_set(x_training[tr_natp_corr_pred], train_aspects[tr_natp_corr_pred],
                                                       tr_word_sentiments[tr_natp_corr_pred],
                                                       tr_aspect_sentiments[tr_natp_corr_pred],
                                                       tr_relations[tr_natp_corr_pred], tr_pos_tags[tr_natp_corr_pred],
                                                       tr_mentions[tr_natp_corr_pred])

        with open(self.neural_language_model.config.tr_file_of_hid_natp_corr_pred, 'w') as outfile:
            json.dump(tr_natp_corr_pred_fv, outfile, ensure_ascii=False)

        tr_natp_wrong_pred_fv = self.create_feature_set(x_training[tr_natp_wrong_pred],
                                                        train_aspects[tr_natp_wrong_pred],
                                                        tr_word_sentiments[tr_natp_wrong_pred],
                                                        tr_aspect_sentiments[tr_natp_wrong_pred],
                                                        tr_relations[tr_natp_wrong_pred],
                                                        tr_pos_tags[tr_natp_wrong_pred],
                                                        tr_mentions[tr_natp_wrong_pred])

        with open(self.neural_language_model.config.tr_file_of_hid_natp_wrong_pred, 'w') as outfile:
            json.dump(tr_natp_wrong_pred_fv, outfile, ensure_ascii=False)
        ...
        te_atp_corr_pred_fv = self.create_feature_set(x_test[te_atp_corr_pred], test_aspects[te_atp_corr_pred],
                                                      te_word_sentiments[te_atp_corr_pred],
                                                      te_aspect_sentiments[te_atp_corr_pred],
                                                      te_relations[te_atp_corr_pred], te_pos_tags[te_atp_corr_pred],
                                                      te_mentions[te_atp_corr_pred])

        with open(self.neural_language_model.config.te_file_of_hid_atp_corr_pred, 'w') as outfile:
            json.dump(te_atp_corr_pred_fv, outfile, ensure_ascii=False)

        te_atp_wrong_pred_fv = self.create_feature_set(x_test[te_atp_wrong_pred], test_aspects[te_atp_wrong_pred],
                                                       te_word_sentiments[te_atp_wrong_pred],
                                                       te_aspect_sentiments[te_atp_wrong_pred],
                                                       te_relations[te_atp_wrong_pred],
                                                       te_pos_tags[te_atp_wrong_pred], te_mentions[te_atp_wrong_pred])

        with open(self.neural_language_model.config.te_file_of_hid_atp_wrong_pred, 'w') as outfile:
            json.dump(te_atp_wrong_pred_fv, outfile, ensure_ascii=False)

        te_natp_corr_pred_fv = self.create_feature_set(x_test[te_natp_corr_pred], test_aspects[te_natp_corr_pred],
                                                       te_word_sentiments[te_natp_corr_pred],
                                                       te_aspect_sentiments[te_natp_corr_pred],
                                                       te_relations[te_natp_corr_pred], te_pos_tags[te_natp_corr_pred],
                                                       te_mentions[te_natp_corr_pred])

        with open(self.neural_language_model.config.te_file_of_hid_natp_corr_pred, 'w') as outfile:
            json.dump(te_natp_corr_pred_fv, outfile, ensure_ascii=False)

        te_natp_wrong_pred_fv = self.create_feature_set(x_test[te_natp_wrong_pred],
                                                        test_aspects[te_natp_wrong_pred],
                                                        te_word_sentiments[te_natp_wrong_pred],
                                                        te_aspect_sentiments[te_natp_wrong_pred],
                                                        te_relations[te_natp_wrong_pred],
                                                        te_pos_tags[te_natp_wrong_pred],
                                                        te_mentions[te_natp_wrong_pred])

        with open(self.neural_language_model.config.te_file_of_hid_natp_wrong_pred, 'w') as outfile:
            json.dump(te_natp_wrong_pred_fv, outfile, ensure_ascii=False)
                ...
                if self.neural_language_model.config.name_of_model == "LCR_Rot_hop_model":
                    ...
                    for i in range(self.neural_language_model.config.n_iterations_hop):
                        weighted_hidden_state['weighted_left_hidden_state_' + str(i)].append(
                            tr_layer_information['weighted_left_hidden_state_' + str(i)][0][j].tolist())
                else:
                ...
                if self.neural_language_model.config.name_of_model == "LCR_Rot_hop_model":
                    ...
                    for i in range(self.neural_language_model.config.n_iterations_hop):
                        weighted_hidden_state['weighted_right_hidden_state_' + str(i)].append(
                            tr_layer_information['weighted_right_hidden_state_' + str(i)][0][j].tolist())
                else:
    ...
    def run(self):
        ...
        with open(self.neural_language_model.config.tr_file_of_hid_atp_corr_pred, 'r') as file:
            for line in file:
                tr_atp_corr_pred_fv = json.loads(line)
        with open(self.neural_language_model.config.tr_file_of_hid_atp_wrong_pred, 'r') as file:
            for line in file:
                tr_atp_wrong_pred_fv = json.loads(line)
        with open(self.neural_language_model.config.tr_file_of_hid_natp_corr_pred, 'r') as file:
            for line in file:
                tr_natp_corr_pred_fv = json.loads(line)
        with open(self.neural_language_model.config.tr_file_of_hid_natp_wrong_pred, 'r') as file:
            for line in file:
                tr_natp_wrong_pred_fv = json.loads(line)
        ...
        with open(self.neural_language_model.config.te_file_of_hid_atp_corr_pred, 'r') as file:
            for line in file:
                te_atp_corr_pred_fv = json.loads(line)
        with open(self.neural_language_model.config.te_file_of_hid_atp_wrong_pred, 'r') as file:
            for line in file:
                te_atp_wrong_pred_fv = json.loads(line)
        with open(self.neural_language_model.config.te_file_of_hid_natp_corr_pred, 'r') as file:
            for line in file:
                te_natp_corr_pred_fv = json.loads(line)
        with open(self.neural_language_model.config.te_file_of_hid_natp_wrong_pred, 'r') as file:
            for line in file:
                te_natp_wrong_pred_fv = json.loads(line)
        ...
        for interest, value in self.diagnostic_classifiers.items():
            ...
            if value:
                ...
                self.predict_diagnostic_classifier(configurations[interest], tr_wrong_pred_fv, interest,
                                                   'tr_wrong_pred')
                self.predict_diagnostic_classifier(configurations[interest], tr_atp_corr_pred_fv, interest,
                                                   'tr_atp_corr_pred')
                self.predict_diagnostic_classifier(configurations[interest], tr_atp_wrong_pred_fv, interest,
                                                   'tr_atp_wrong_pred')
                self.predict_diagnostic_classifier(configurations[interest], tr_natp_corr_pred_fv, interest,
                                                   'tr_natp_corr_pred')
                self.predict_diagnostic_classifier(configurations[interest], tr_natp_wrong_pred_fv, interest,
                                                   'tr_natp_wrong_pred')
                ...
                self.predict_diagnostic_classifier(configurations[interest], te_wrong_pred_fv, interest,
                                                   'te_wrong_pred')
                self.predict_diagnostic_classifier(configurations[interest], te_atp_corr_pred_fv, interest,
                                                   'te_atp_corr_pred')
                self.predict_diagnostic_classifier(configurations[interest], te_atp_wrong_pred_fv, interest,
                                                   'te_atp_wrong_pred')
                self.predict_diagnostic_classifier(configurations[interest], te_natp_corr_pred_fv, interest,
                                                   'te_natp_corr_pred')
                self.predict_diagnostic_classifier(configurations[interest], te_natp_wrong_pred_fv, interest,
                                                   'te_natp_wrong_pred')
    ...
    def fit_diagnostic_classifier(self, diagnostic_config, feature_values, interest):
        ...
        if not os.path.isfile(file+".index"):
            diagnostic_config.classifier_embeddings.fit(
                np.array(feature_values['left_word_embeddings'])[left_random_indices], tr_left_y[left_random_indices],
        ...
        if not os.path.isfile(file+".index"):
            diagnostic_config.classifier_embeddings.fit(
                np.array(feature_values['right_word_embeddings'])[right_random_indices],
        ...
        if not os.path.isfile(file+".index"):
            diagnostic_config.classifier_states.fit(
                np.array(feature_values['left_hidden_states'])[left_random_indices], tr_left_y[left_random_indices],
        ...
        if not os.path.isfile(file+".index"):
            diagnostic_config.classifier_states.fit(
                np.array(feature_values['right_hidden_states'])[right_random_indices], tr_right_y[right_random_indices],
    ...
    def predict_diagnostic_classifier(self, diagnostic_config, feature_values, interest, name):
        ...
        if os.path.isfile(file+".index"):
            pred_left_word_embeddings = np.array(diagnostic_config.classifier_embeddings.predict(
                np.array(feature_values['left_word_embeddings']), file, '_le'))[0]
        ...
        if os.path.isfile(file+".index"):
            pred_right_word_embeddings = np.array(diagnostic_config.classifier_embeddings.predict(
                np.array(feature_values['right_word_embeddings']), file, '_re'))[0]
        ...
        if os.path.isfile(file+".index"):
            pred_left_hidden_states = np.array(diagnostic_config.classifier_states.predict(
                np.array(feature_values['left_hidden_states']), file, '_ls'))[0]
        ...
        if os.path.isfile(file+".index"):
            pred_right_hidden_states = np.array(diagnostic_config.classifier_states.predict(
                np.array(feature_values['right_hidden_states']), file, '_rs'))[0]
        ...
        if self.neural_language_model.config.name_of_model == "LCR_Rot_hop_model":
            ...
            for i in range(self.neural_language_model.config.n_iterations_hop):
                ...
                if os.path.isfile(file+".index"):
                    ...
                    for index in range(arg_max_pred.shape[0]):
                        if arg_max_pred[index] == argmax_left_y[index]:
                            acc_weighted_hidden_state['acc_weighted_left_hidden_state_' + str(i)][arg_max_pred[index]] += 1
